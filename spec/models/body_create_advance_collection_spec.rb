...
# Unit tests for Colending::BodyCreateAdvanceCollection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyCreateAdvanceCollection' do
  before do
    # run before each test
    @instance = Colending::BodyCreateAdvanceCollection.new
  end
  ...
  describe 'test an instance of BodyCreateAdvanceCollection' do
    it 'should create an instance of BodyCreateAdvanceCollection' do
      expect(@instance).to be_instance_of(Colending::BodyCreateAdvanceCollection)
    end
  end
  ...
  describe 'test attribute "advance_outstanding"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
