...
# Unit tests for Colending::LoanId
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LoanId' do
  before do
    # run before each test
    @instance = Colending::LoanId.new
  end
  ...
  describe 'test an instance of LoanId' do
    it 'should create an instance of LoanId' do
      expect(@instance).to be_instance_of(Colending::LoanId)
    end
  end
end
