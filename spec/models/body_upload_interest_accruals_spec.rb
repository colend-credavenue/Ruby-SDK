...
# Unit tests for Colending::BodyUploadInterestAccruals
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyUploadInterestAccruals' do
  before do
    # run before each test
    @instance = Colending::BodyUploadInterestAccruals.new
  end
  ...
  describe 'test an instance of BodyUploadInterestAccruals' do
    it 'should create an instance of BodyUploadInterestAccruals' do
      expect(@instance).to be_instance_of(Colending::BodyUploadInterestAccruals)
    end
  end
  ...
  describe 'test attribute "file_link_password"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
