...
# Unit tests for Colending::BodyCreateLoanLinkedLoanInfos
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyCreateLoanLinkedLoanInfos' do
  before do
    # run before each test
    @instance = Colending::BodyCreateLoanLinkedLoanInfos.new
  end
  ...
  describe 'test an instance of BodyCreateLoanLinkedLoanInfos' do
    it 'should create an instance of BodyCreateLoanLinkedLoanInfos' do
      expect(@instance).to be_instance_of(Colending::BodyCreateLoanLinkedLoanInfos)
    end
  end
  describe 'test attribute "linked_loan_id"' do
    it 'should work' do
