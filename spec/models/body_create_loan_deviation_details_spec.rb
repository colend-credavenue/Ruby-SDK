...
# Unit tests for Colending::BodyCreateLoanDeviationDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyCreateLoanDeviationDetails' do
  before do
    # run before each test
    @instance = Colending::BodyCreateLoanDeviationDetails.new
  end
  ...
  describe 'test an instance of BodyCreateLoanDeviationDetails' do
    it 'should create an instance of BodyCreateLoanDeviationDetails' do
      expect(@instance).to be_instance_of(Colending::BodyCreateLoanDeviationDetails)
    end
  end
  ...
  describe 'test attribute "mitigant"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
