...
# Unit tests for Colending::BodyUpdateLoan
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyUpdateLoan' do
  before do
    # run before each test
    @instance = Colending::BodyUpdateLoan.new
  end
  ...
  describe 'test an instance of BodyUpdateLoan' do
    it 'should create an instance of BodyUpdateLoan' do
      expect(@instance).to be_instance_of(Colending::BodyUpdateLoan)
    end
  end
