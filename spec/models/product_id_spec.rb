...
# Unit tests for Colending::ProductId
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProductId' do
  before do
    # run before each test
    @instance = Colending::ProductId.new
  end
  ...
  describe 'test an instance of ProductId' do
    it 'should create an instance of ProductId' do
      expect(@instance).to be_instance_of(Colending::ProductId)
    end
  end
end
