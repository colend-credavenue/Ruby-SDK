...
# Unit tests for Colending::ResponseCreateTranche
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseCreateTranche' do
  before do
    # run before each test
    @instance = Colending::ResponseCreateTranche.new
  end
  ...
  describe 'test an instance of ResponseCreateTranche' do
    it 'should create an instance of ResponseCreateTranche' do
      expect(@instance).to be_instance_of(Colending::ResponseCreateTranche)
    end
  end
  describe 'test attribute "tranche_number"' do
    it 'should work' do
  ...
  describe 'test attribute "closing_loan_principal"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "tranche_doc_link"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "tranche_doc_link_password"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "loan_data"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "bureau_report_data"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "business_data"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
