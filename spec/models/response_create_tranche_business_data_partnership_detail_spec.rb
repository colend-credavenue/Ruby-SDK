...
# Unit tests for Colending::ResponseCreateTrancheBusinessDataPartnershipDetail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseCreateTrancheBusinessDataPartnershipDetail' do
  before do
    # run before each test
    @instance = Colending::ResponseCreateTrancheBusinessDataPartnershipDetail.new
  end
  ...
  describe 'test an instance of ResponseCreateTrancheBusinessDataPartnershipDetail' do
    it 'should create an instance of ResponseCreateTrancheBusinessDataPartnershipDetail' do
      expect(@instance).to be_instance_of(Colending::ResponseCreateTrancheBusinessDataPartnershipDetail)
    end
  end
  describe 'test attribute "partnership_firm_pan"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "partnership_pan_link"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "partnership_pan_link_password"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "partnership_deed_link"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "partnership_deed_link_password"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "beneficiary_owner_details_link"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "beneficiary_owner_details_link_password"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
