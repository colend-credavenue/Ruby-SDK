...
# Unit tests for Colending::CreateCollectionSuccess
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateCollectionSuccess' do
  before do
    # run before each test
    @instance = Colending::CreateCollectionSuccess.new
  end
  ...
  describe 'test an instance of CreateCollectionSuccess' do
    it 'should create an instance of CreateCollectionSuccess' do
      expect(@instance).to be_instance_of(Colending::CreateCollectionSuccess)
    end
  end
