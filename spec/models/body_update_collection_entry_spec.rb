...
# Unit tests for Colending::BodyUpdateCollectionEntry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyUpdateCollectionEntry' do
  before do
    # run before each test
    @instance = Colending::BodyUpdateCollectionEntry.new
  end
  ...
  describe 'test an instance of BodyUpdateCollectionEntry' do
    it 'should create an instance of BodyUpdateCollectionEntry' do
      expect(@instance).to be_instance_of(Colending::BodyUpdateCollectionEntry)
    end
  end
