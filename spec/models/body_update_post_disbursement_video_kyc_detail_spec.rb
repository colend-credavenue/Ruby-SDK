...
# Unit tests for Colending::BodyUpdatePostDisbursementVideoKycDetail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyUpdatePostDisbursementVideoKycDetail' do
  before do
    # run before each test
    @instance = Colending::BodyUpdatePostDisbursementVideoKycDetail.new
  end
  ...
  describe 'test an instance of BodyUpdatePostDisbursementVideoKycDetail' do
    it 'should create an instance of BodyUpdatePostDisbursementVideoKycDetail' do
      expect(@instance).to be_instance_of(Colending::BodyUpdatePostDisbursementVideoKycDetail)
    end
  end
