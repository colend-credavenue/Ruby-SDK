...
# Unit tests for Colending::BodyUpdateRepaymentSchedule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyUpdateRepaymentSchedule' do
  before do
    # run before each test
    @instance = Colending::BodyUpdateRepaymentSchedule.new
  end
  ...
  describe 'test an instance of BodyUpdateRepaymentSchedule' do
    it 'should create an instance of BodyUpdateRepaymentSchedule' do
      expect(@instance).to be_instance_of(Colending::BodyUpdateRepaymentSchedule)
    end
  end
  describe 'test attribute "repayment_schedules"' do
    it 'should work' do
