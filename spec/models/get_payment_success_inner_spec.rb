...
# Unit tests for Colending::GetPaymentSuccessInner
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetPaymentSuccessInner' do
  before do
    # run before each test
    @instance = Colending::GetPaymentSuccessInner.new
  end
  ...
  describe 'test an instance of GetPaymentSuccessInner' do
    it 'should create an instance of GetPaymentSuccessInner' do
      expect(@instance).to be_instance_of(Colending::GetPaymentSuccessInner)
    end
  end
