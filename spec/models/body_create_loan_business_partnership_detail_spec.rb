...
# Unit tests for Colending::BodyCreateLoanBusinessPartnershipDetail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyCreateLoanBusinessPartnershipDetail' do
  before do
    # run before each test
    @instance = Colending::BodyCreateLoanBusinessPartnershipDetail.new
  end
  ...
  describe 'test an instance of BodyCreateLoanBusinessPartnershipDetail' do
    it 'should create an instance of BodyCreateLoanBusinessPartnershipDetail' do
      expect(@instance).to be_instance_of(Colending::BodyCreateLoanBusinessPartnershipDetail)
    end
  end
