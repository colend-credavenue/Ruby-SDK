...
# Unit tests for Colending::GetRSSuccess
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetRSSuccess' do
  before do
    # run before each test
    @instance = Colending::GetRSSuccess.new
  end
  ...
  describe 'test an instance of GetRSSuccess' do
    it 'should create an instance of GetRSSuccess' do
      expect(@instance).to be_instance_of(Colending::GetRSSuccess)
    end
  end
end
