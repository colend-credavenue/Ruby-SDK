...
# Unit tests for Colending::BodyDisburseLoan
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyDisburseLoan' do
  before do
    # run before each test
    @instance = Colending::BodyDisburseLoan.new
  end
  ...
  describe 'test an instance of BodyDisburseLoan' do
    it 'should create an instance of BodyDisburseLoan' do
      expect(@instance).to be_instance_of(Colending::BodyDisburseLoan)
    end
  end
  ...
  describe 'test attribute "disbursement_date"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "penny_test_status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "penny_test_report_link"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "penny_test_report_link_password"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
