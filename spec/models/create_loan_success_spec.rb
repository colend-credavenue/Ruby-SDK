...
# Unit tests for Colending::CreateLoanSuccess
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateLoanSuccess' do
  before do
    # run before each test
    @instance = Colending::CreateLoanSuccess.new
  end
  ...
  describe 'test an instance of CreateLoanSuccess' do
    it 'should create an instance of CreateLoanSuccess' do
      expect(@instance).to be_instance_of(Colending::CreateLoanSuccess)
    end
  end
