...
# Unit tests for Colending::PropertyReviewSuccess
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PropertyReviewSuccess' do
  before do
    # run before each test
    @instance = Colending::PropertyReviewSuccess.new
  end
  ...
  describe 'test an instance of PropertyReviewSuccess' do
    it 'should create an instance of PropertyReviewSuccess' do
      expect(@instance).to be_instance_of(Colending::PropertyReviewSuccess)
    end
  end
