...
# Unit tests for Colending::CreateLoanError
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateLoanError' do
  before do
    # run before each test
    @instance = Colending::CreateLoanError.new
  end
  ...
  describe 'test an instance of CreateLoanError' do
    it 'should create an instance of CreateLoanError' do
      expect(@instance).to be_instance_of(Colending::CreateLoanError)
    end
  end
