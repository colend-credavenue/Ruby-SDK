...
# Unit tests for Colending::BodyCreateRepaymentScheduleRepaymentSchedules
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyCreateRepaymentScheduleRepaymentSchedules' do
  before do
    # run before each test
    @instance = Colending::BodyCreateRepaymentScheduleRepaymentSchedules.new
  end
  ...
  describe 'test an instance of BodyCreateRepaymentScheduleRepaymentSchedules' do
    it 'should create an instance of BodyCreateRepaymentScheduleRepaymentSchedules' do
      expect(@instance).to be_instance_of(Colending::BodyCreateRepaymentScheduleRepaymentSchedules)
    end
  end
