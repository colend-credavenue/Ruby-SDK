...
# Unit tests for Colending::BodyUpdateRepaymentScheduleRepaymentSchedules
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyUpdateRepaymentScheduleRepaymentSchedules' do
  before do
    # run before each test
    @instance = Colending::BodyUpdateRepaymentScheduleRepaymentSchedules.new
  end
  ...
  describe 'test an instance of BodyUpdateRepaymentScheduleRepaymentSchedules' do
    it 'should create an instance of BodyUpdateRepaymentScheduleRepaymentSchedules' do
      expect(@instance).to be_instance_of(Colending::BodyUpdateRepaymentScheduleRepaymentSchedules)
    end
  end
