...
# Unit tests for Colending::BodyGetLoanDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyGetLoanDetails' do
  before do
    # run before each test
    @instance = Colending::BodyGetLoanDetails.new
  end
  ...
  describe 'test an instance of BodyGetLoanDetails' do
    it 'should create an instance of BodyGetLoanDetails' do
      expect(@instance).to be_instance_of(Colending::BodyGetLoanDetails)
    end
  end
