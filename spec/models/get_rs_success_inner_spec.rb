...
# Unit tests for Colending::GetRSSuccessInner
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetRSSuccessInner' do
  before do
    # run before each test
    @instance = Colending::GetRSSuccessInner.new
  end
  ...
  describe 'test an instance of GetRSSuccessInner' do
    it 'should create an instance of GetRSSuccessInner' do
      expect(@instance).to be_instance_of(Colending::GetRSSuccessInner)
    end
  end
  ...
  describe 'test attribute "emi"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
