...
# Unit tests for Colending::BodyCreateLoanBusinessPartnerships
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyCreateLoanBusinessPartnerships' do
  before do
    # run before each test
    @instance = Colending::BodyCreateLoanBusinessPartnerships.new
  end
  ...
  describe 'test an instance of BodyCreateLoanBusinessPartnerships' do
    it 'should create an instance of BodyCreateLoanBusinessPartnerships' do
      expect(@instance).to be_instance_of(Colending::BodyCreateLoanBusinessPartnerships)
    end
  end
  ...
  describe 'test attribute "poi_number"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "poi_link"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "poi_link_password"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "poa_number"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "poa_link"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "poa_link_password"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
