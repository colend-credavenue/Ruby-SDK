...
# Unit tests for Colending::ResponseCreateTrancheDisbursementAccounts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseCreateTrancheDisbursementAccounts' do
  before do
    # run before each test
    @instance = Colending::ResponseCreateTrancheDisbursementAccounts.new
  end
  ...
  describe 'test an instance of ResponseCreateTrancheDisbursementAccounts' do
    it 'should create an instance of ResponseCreateTrancheDisbursementAccounts' do
      expect(@instance).to be_instance_of(Colending::ResponseCreateTrancheDisbursementAccounts)
    end
  end
