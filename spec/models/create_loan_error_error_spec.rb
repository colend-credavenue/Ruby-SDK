...
# Unit tests for Colending::CreateLoanErrorError
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateLoanErrorError' do
  before do
    # run before each test
    @instance = Colending::CreateLoanErrorError.new
  end
  ...
  describe 'test an instance of CreateLoanErrorError' do
    it 'should create an instance of CreateLoanErrorError' do
      expect(@instance).to be_instance_of(Colending::CreateLoanErrorError)
    end
  end
