...
# Unit tests for Colending::BodyCreateLoanReferences
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyCreateLoanReferences' do
  before do
    # run before each test
    @instance = Colending::BodyCreateLoanReferences.new
  end
  ...
  describe 'test an instance of BodyCreateLoanReferences' do
    it 'should create an instance of BodyCreateLoanReferences' do
      expect(@instance).to be_instance_of(Colending::BodyCreateLoanReferences)
    end
  end
  ...
  describe 'test attribute "pincode"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
