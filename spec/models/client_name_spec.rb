...
# Unit tests for Colending::ClientName
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ClientName' do
  before do
    # run before each test
    @instance = Colending::ClientName.new
  end
  ...
  describe 'test an instance of ClientName' do
    it 'should create an instance of ClientName' do
      expect(@instance).to be_instance_of(Colending::ClientName)
    end
  end
end
