...
# Unit tests for Colending::GetPaymentSuccess
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetPaymentSuccess' do
  before do
    # run before each test
    @instance = Colending::GetPaymentSuccess.new
  end
  ...
  describe 'test an instance of GetPaymentSuccess' do
    it 'should create an instance of GetPaymentSuccess' do
      expect(@instance).to be_instance_of(Colending::GetPaymentSuccess)
    end
  end
end
