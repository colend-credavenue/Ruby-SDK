...
# Unit tests for Colending::Error422CreateTranche
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Error422CreateTranche' do
  before do
    # run before each test
    @instance = Colending::Error422CreateTranche.new
  end
  ...
  describe 'test an instance of Error422CreateTranche' do
    it 'should create an instance of Error422CreateTranche' do
      expect(@instance).to be_instance_of(Colending::Error422CreateTranche)
    end
  end
