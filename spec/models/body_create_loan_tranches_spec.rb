...
# Unit tests for Colending::BodyCreateLoanTranches
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyCreateLoanTranches' do
  before do
    # run before each test
    @instance = Colending::BodyCreateLoanTranches.new
  end
  ...
  describe 'test an instance of BodyCreateLoanTranches' do
    it 'should create an instance of BodyCreateLoanTranches' do
      expect(@instance).to be_instance_of(Colending::BodyCreateLoanTranches)
    end
  end
