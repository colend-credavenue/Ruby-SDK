...
# Unit tests for Colending::AgreementSignedSuccess
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AgreementSignedSuccess' do
  before do
    # run before each test
    @instance = Colending::AgreementSignedSuccess.new
  end
  ...
  describe 'test an instance of AgreementSignedSuccess' do
    it 'should create an instance of AgreementSignedSuccess' do
      expect(@instance).to be_instance_of(Colending::AgreementSignedSuccess)
    end
  end
