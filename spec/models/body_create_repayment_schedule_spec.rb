...
# Unit tests for Colending::BodyCreateRepaymentSchedule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyCreateRepaymentSchedule' do
  before do
    # run before each test
    @instance = Colending::BodyCreateRepaymentSchedule.new
  end
  ...
  describe 'test an instance of BodyCreateRepaymentSchedule' do
    it 'should create an instance of BodyCreateRepaymentSchedule' do
      expect(@instance).to be_instance_of(Colending::BodyCreateRepaymentSchedule)
    end
  end
