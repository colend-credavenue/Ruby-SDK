...
# Unit tests for Colending::BodyApproveFundTransfer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyApproveFundTransfer' do
  before do
    # run before each test
    @instance = Colending::BodyApproveFundTransfer.new
  end
  ...
  describe 'test an instance of BodyApproveFundTransfer' do
    it 'should create an instance of BodyApproveFundTransfer' do
      expect(@instance).to be_instance_of(Colending::BodyApproveFundTransfer)
    end
  end
end
