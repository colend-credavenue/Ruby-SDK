...
# Unit tests for Colending::PaymentIdUpdateCollectionEntry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentIdUpdateCollectionEntry' do
  before do
    # run before each test
    @instance = Colending::PaymentIdUpdateCollectionEntry.new
  end
  ...
  describe 'test an instance of PaymentIdUpdateCollectionEntry' do
    it 'should create an instance of PaymentIdUpdateCollectionEntry' do
      expect(@instance).to be_instance_of(Colending::PaymentIdUpdateCollectionEntry)
    end
  end
end
