...
# Unit tests for Colending::BodyCreateLoanVideoKycDetail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyCreateLoanVideoKycDetail' do
  before do
    # run before each test
    @instance = Colending::BodyCreateLoanVideoKycDetail.new
  end
  ...
  describe 'test an instance of BodyCreateLoanVideoKycDetail' do
    it 'should create an instance of BodyCreateLoanVideoKycDetail' do
      expect(@instance).to be_instance_of(Colending::BodyCreateLoanVideoKycDetail)
    end
  end
