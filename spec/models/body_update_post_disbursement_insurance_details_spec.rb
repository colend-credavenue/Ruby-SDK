...
# Unit tests for Colending::BodyUpdatePostDisbursementInsuranceDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyUpdatePostDisbursementInsuranceDetails' do
  before do
    # run before each test
    @instance = Colending::BodyUpdatePostDisbursementInsuranceDetails.new
  end
  ...
  describe 'test an instance of BodyUpdatePostDisbursementInsuranceDetails' do
    it 'should create an instance of BodyUpdatePostDisbursementInsuranceDetails' do
      expect(@instance).to be_instance_of(Colending::BodyUpdatePostDisbursementInsuranceDetails)
    end
  end
  ...
  describe 'test attribute "insurer_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "nominee_details"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
