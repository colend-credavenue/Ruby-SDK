...
# Unit tests for Colending::BodyDisburseLoanDisbursementAccounts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyDisburseLoanDisbursementAccounts' do
  before do
    # run before each test
    @instance = Colending::BodyDisburseLoanDisbursementAccounts.new
  end
  ...
  describe 'test an instance of BodyDisburseLoanDisbursementAccounts' do
    it 'should create an instance of BodyDisburseLoanDisbursementAccounts' do
      expect(@instance).to be_instance_of(Colending::BodyDisburseLoanDisbursementAccounts)
    end
  end
  ...
  describe 'test attribute "disbursed_amount"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
