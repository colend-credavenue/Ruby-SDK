...
# Unit tests for Colending::BodyUpdateAdvanceCollection
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyUpdateAdvanceCollection' do
  before do
    # run before each test
    @instance = Colending::BodyUpdateAdvanceCollection.new
  end
  ...
  describe 'test an instance of BodyUpdateAdvanceCollection' do
    it 'should create an instance of BodyUpdateAdvanceCollection' do
      expect(@instance).to be_instance_of(Colending::BodyUpdateAdvanceCollection)
    end
  end
