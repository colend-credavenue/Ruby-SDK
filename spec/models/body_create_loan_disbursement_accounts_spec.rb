...
# Unit tests for Colending::BodyCreateLoanDisbursementAccounts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyCreateLoanDisbursementAccounts' do
  before do
    # run before each test
    @instance = Colending::BodyCreateLoanDisbursementAccounts.new
  end
  ...
  describe 'test an instance of BodyCreateLoanDisbursementAccounts' do
    it 'should create an instance of BodyCreateLoanDisbursementAccounts' do
      expect(@instance).to be_instance_of(Colending::BodyCreateLoanDisbursementAccounts)
    end
  end
  ...
  describe 'test attribute "date_of_bank_account_opening"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "bank_branch_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
