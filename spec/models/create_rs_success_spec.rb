...
# Unit tests for Colending::CreateRSSuccess
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateRSSuccess' do
  before do
    # run before each test
    @instance = Colending::CreateRSSuccess.new
  end
  ...
  describe 'test an instance of CreateRSSuccess' do
    it 'should create an instance of CreateRSSuccess' do
      expect(@instance).to be_instance_of(Colending::CreateRSSuccess)
    end
  end
