...
# Unit tests for Colending::RequestSuccess
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestSuccess' do
  before do
    # run before each test
    @instance = Colending::RequestSuccess.new
  end
  ...
  describe 'test an instance of RequestSuccess' do
    it 'should create an instance of RequestSuccess' do
      expect(@instance).to be_instance_of(Colending::RequestSuccess)
    end
  end
