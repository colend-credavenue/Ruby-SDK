...
# Unit tests for Colending::BodyCreateLoanInsuranceDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyCreateLoanInsuranceDetails' do
  before do
    # run before each test
    @instance = Colending::BodyCreateLoanInsuranceDetails.new
  end
  ...
  describe 'test an instance of BodyCreateLoanInsuranceDetails' do
    it 'should create an instance of BodyCreateLoanInsuranceDetails' do
      expect(@instance).to be_instance_of(Colending::BodyCreateLoanInsuranceDetails)
    end
  end
  ...
  describe 'test attribute "nominee_date_of_birth"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
