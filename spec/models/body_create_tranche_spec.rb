...
# Unit tests for Colending::BodyCreateTranche
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyCreateTranche' do
  before do
    # run before each test
    @instance = Colending::BodyCreateTranche.new
  end
  ...
  describe 'test an instance of BodyCreateTranche' do
    it 'should create an instance of BodyCreateTranche' do
      expect(@instance).to be_instance_of(Colending::BodyCreateTranche)
    end
  end
