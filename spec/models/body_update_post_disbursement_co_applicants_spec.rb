...
# Unit tests for Colending::BodyUpdatePostDisbursementCoApplicants
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BodyUpdatePostDisbursementCoApplicants' do
  before do
    # run before each test
    @instance = Colending::BodyUpdatePostDisbursementCoApplicants.new
  end
  ...
  describe 'test an instance of BodyUpdatePostDisbursementCoApplicants' do
    it 'should create an instance of BodyUpdatePostDisbursementCoApplicants' do
      expect(@instance).to be_instance_of(Colending::BodyUpdatePostDisbursementCoApplicants)
    end
  end
  ...
  describe 'test attribute "bank_statement_12_months_link"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "pan_link"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "video_kyc_link"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "video_kyc_profile_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "video_kyc_account_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "video_kyc_key"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
