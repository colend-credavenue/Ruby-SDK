...
module Colending
  class BodyDisburseLoan
    ...
    # Penny Test Status
    attr_accessor :penny_test_status

    # Penny Test Status Report Link
    attr_accessor :penny_test_report_link

    # Penny Test Status Report Link Password
    attr_accessor :penny_test_report_link_password
    ...
    def self.attribute_map
      {
        ...
        :'penny_test_report_link' => :'penny_test_report_link',
        :'penny_test_report_link_password' => :'penny_test_report_link_password',
    ...
    def self.openapi_types
      {
        ...
        :'penny_test_report_link' => :'Object',
        :'penny_test_report_link_password' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Colending::BodyDisburseLoan` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Colending::BodyDisburseLoan`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'instrument_number')
        self.instrument_number = attributes[:'instrument_number']
      end
      ...
      if attributes.key?(:'penny_test_status')
        self.penny_test_status = attributes[:'penny_test_status']
      end

      if attributes.key?(:'penny_test_report_link')
        if (value = attributes[:'penny_test_report_link']).is_a?(Array)
          self.penny_test_report_link = value
        end
      end

      if attributes.key?(:'penny_test_report_link_password')
        self.penny_test_report_link_password = attributes[:'penny_test_report_link_password']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          penny_test_report_link == o.penny_test_report_link &&
          penny_test_report_link_password == o.penny_test_report_link_password &&
