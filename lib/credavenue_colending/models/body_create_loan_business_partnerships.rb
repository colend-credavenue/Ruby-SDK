...
module Colending
  ...
  class BodyCreateLoanBusinessPartnerships
    ...
    attr_accessor :poi_number

    # Proof of Identity for 1st authorized person
    attr_accessor :poi_link

    # Proof of Identity for 1st authorized person
    attr_accessor :poi_link_password

    # KYC number of the authorised person/director
    attr_accessor :poa_number

    # Proof of address for 1st authorized person/director
    attr_accessor :poa_link

    # Proof of address for 1st authorized person/director
    attr_accessor :poa_link_password
    ...
    def self.attribute_map
      {
        ...
        :'poi_link' => :'poi_link',
        :'poi_link_password' => :'poi_link_password',
        :'poa_number' => :'poa_number',
        :'poa_link' => :'poa_link',
        :'poa_link_password' => :'poa_link_password',
    ...
    def self.openapi_types
      {
        ...
        :'poi_number' => :'Object',
        :'poi_link' => :'Object',
        :'poi_link_password' => :'Object',
        :'poa_number' => :'Object',
        :'poa_link' => :'Object',
        :'poa_link_password' => :'Object',
        :'photo_link' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Colending::BodyCreateLoanBusinessPartnerships` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Colending::BodyCreateLoanBusinessPartnerships`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'poi_number')
        self.poi_number = attributes[:'poi_number']
      end

      if attributes.key?(:'poi_link')
        if (value = attributes[:'poi_link']).is_a?(Array)
          self.poi_link = value
        end
      end

      if attributes.key?(:'poi_link_password')
        self.poi_link_password = attributes[:'poi_link_password']
      end

      if attributes.key?(:'poa_number')
        self.poa_number = attributes[:'poa_number']
      end

      if attributes.key?(:'poa_link')
        if (value = attributes[:'poa_link']).is_a?(Array)
          self.poa_link = value
        end
      end

      if attributes.key?(:'poa_link_password')
        self.poa_link_password = attributes[:'poa_link_password']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          poi_number == o.poi_number &&
          poi_link == o.poi_link &&
          poi_link_password == o.poi_link_password &&
          poa_number == o.poa_number &&
          poa_link == o.poa_link &&
          poa_link_password == o.poa_link_password &&
    ...
    def hash
      [partnership_type, name, poi_number, poi_link, poi_link_password, poa_number, poa_link, poa_link_password, photo_link, photo_link_password].hash
    end
