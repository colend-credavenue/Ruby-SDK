...
module Colending
  class ResponseCreateTranche
    # Tranche Number
    attr_accessor :tranche_number
    ...
    def self.attribute_map
      {
        ...
        :'closing_loan_principal' => :'closing_loan_principal',
        :'tranche_doc_link' => :'tranche_doc_link',
        :'tranche_doc_link_password' => :'tranche_doc_link_password',
        :'disbursement_accounts' => :'disbursement_accounts',
        :'loan_data' => :'loan_data',
        :'bureau_report_data' => :'bureau_report_data',
    ...
    def self.openapi_types
      {
        ...
        :'closing_loan_principal' => :'Object',
        :'tranche_doc_link' => :'Object',
        :'tranche_doc_link_password' => :'Object',
        :'disbursement_accounts' => :'Object',
        :'loan_data' => :'Object',
        :'bureau_report_data' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Colending::ResponseCreateTranche` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Colending::ResponseCreateTranche`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'tranche_number')
        self.tranche_number = attributes[:'tranche_number']
      end
      ...
      if attributes.key?(:'closing_loan_principal')
        self.closing_loan_principal = attributes[:'closing_loan_principal']
      end

      if attributes.key?(:'tranche_doc_link')
        self.tranche_doc_link = attributes[:'tranche_doc_link']
      end

      if attributes.key?(:'tranche_doc_link_password')
        self.tranche_doc_link_password = attributes[:'tranche_doc_link_password']
      end
      ...
      if attributes.key?(:'loan_data')
        if (value = attributes[:'loan_data']).is_a?(Array)
          self.loan_data = value
        end
      end

      if attributes.key?(:'bureau_report_data')
        self.bureau_report_data = attributes[:'bureau_report_data']
      end
      ...
      if attributes.key?(:'business_data')
        self.business_data = attributes[:'business_data']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          tranche_number == o.tranche_number &&
          ...
          closing_loan_principal == o.closing_loan_principal &&
          tranche_doc_link == o.tranche_doc_link &&
          tranche_doc_link_password == o.tranche_doc_link_password &&
          disbursement_accounts == o.disbursement_accounts &&
          loan_data == o.loan_data &&
          bureau_report_data == o.bureau_report_data &&
    ...
    def hash
      [tranche_number, principal_amount, differential_interest, interest_start_date, processing_fee, stamp_duty, insurance_charges, documentation_charges, other_charges, closing_loan_principal, tranche_doc_link, tranche_doc_link_password, disbursement_accounts, loan_data, bureau_report_data, client_loan_id, business_data].hash
    end
