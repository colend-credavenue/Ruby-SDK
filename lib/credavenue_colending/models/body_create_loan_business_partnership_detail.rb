...
module Colending
  ...
  class BodyCreateLoanBusinessPartnershipDetail
    # PAN number of partnership
    attr_accessor :partnership_firm_pan

    # PAN image of partnership
    attr_accessor :partnership_pan_link

    # PAN image password of partnership
    attr_accessor :partnership_pan_link_password

    # Partnership deed image
    attr_accessor :partnership_deed_link

    # Partnership deed image password
    attr_accessor :partnership_deed_link_password

    # Shareholding pattern of the firm
    attr_accessor :beneficiary_owner_details_link

    # Shareholding pattern of the firm - password
    attr_accessor :beneficiary_owner_details_link_password

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'partnership_firm_pan' => :'partnership_firm_pan',
        :'partnership_pan_link' => :'partnership_pan_link',
        :'partnership_pan_link_password' => :'partnership_pan_link_password',
        :'partnership_deed_link' => :'partnership_deed_link',
        :'partnership_deed_link_password' => :'partnership_deed_link_password',
        :'beneficiary_owner_details_link' => :'beneficiary_owner_details_link',
        :'beneficiary_owner_details_link_password' => :'beneficiary_owner_details_link_password'
      }
    end
    ...
    def self.openapi_types
      {
        :'partnership_firm_pan' => :'Object',
        :'partnership_pan_link' => :'Object',
        :'partnership_pan_link_password' => :'Object',
        :'partnership_deed_link' => :'Object',
        :'partnership_deed_link_password' => :'Object',
        :'beneficiary_owner_details_link' => :'Object',
        :'beneficiary_owner_details_link_password' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Colending::BodyCreateLoanBusinessPartnershipDetail` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Colending::BodyCreateLoanBusinessPartnershipDetail`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'partnership_firm_pan')
        self.partnership_firm_pan = attributes[:'partnership_firm_pan']
      end

      if attributes.key?(:'partnership_pan_link')
        if (value = attributes[:'partnership_pan_link']).is_a?(Array)
          self.partnership_pan_link = value
        end
      end

      if attributes.key?(:'partnership_pan_link_password')
        self.partnership_pan_link_password = attributes[:'partnership_pan_link_password']
      end

      if attributes.key?(:'partnership_deed_link')
        if (value = attributes[:'partnership_deed_link']).is_a?(Array)
          self.partnership_deed_link = value
        end
      end

      if attributes.key?(:'partnership_deed_link_password')
        self.partnership_deed_link_password = attributes[:'partnership_deed_link_password']
      end

      if attributes.key?(:'beneficiary_owner_details_link')
        if (value = attributes[:'beneficiary_owner_details_link']).is_a?(Array)
          self.beneficiary_owner_details_link = value
        end
      end

      if attributes.key?(:'beneficiary_owner_details_link_password')
        self.beneficiary_owner_details_link_password = attributes[:'beneficiary_owner_details_link_password']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          partnership_firm_pan == o.partnership_firm_pan &&
          partnership_pan_link == o.partnership_pan_link &&
          partnership_pan_link_password == o.partnership_pan_link_password &&
          partnership_deed_link == o.partnership_deed_link &&
          partnership_deed_link_password == o.partnership_deed_link_password &&
          beneficiary_owner_details_link == o.beneficiary_owner_details_link &&
          beneficiary_owner_details_link_password == o.beneficiary_owner_details_link_password
    end
    ...
    def hash
      [partnership_firm_pan, partnership_pan_link, partnership_pan_link_password, partnership_deed_link, partnership_deed_link_password, beneficiary_owner_details_link, beneficiary_owner_details_link_password].hash
    end
