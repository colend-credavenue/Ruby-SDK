...
module Colending
  ...
  class BodyUpdatePostDisbursementFinancialData
    ...
    attr_accessor :other_income_assessment_proof_link
    ...
    def self.attribute_map
      {
        ...
        :'other_income_assessment_proof_link' => :'other_income_assessment_proof_link',
        :'cam_link' => :'cam_link',
        :'cfa_link' => :'cfa_link'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'other_income_assessment_proof_link' => :'Object',
        :'cam_link' => :'Object',
        :'cfa_link' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Colending::BodyUpdatePostDisbursementFinancialData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Colending::BodyUpdatePostDisbursementFinancialData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'other_income_assessment_proof_link')
        if (value = attributes[:'other_income_assessment_proof_link']).is_a?(Array)
          self.other_income_assessment_proof_link = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          other_income_assessment_proof_link == o.other_income_assessment_proof_link &&
          cam_link == o.cam_link &&
          cfa_link == o.cfa_link
    end
    ...
    def hash
      [annual_business_turnover, annual_gross_profit, annual_business_ebitda, monthly_net_profit, annual_net_profit, gst_return_year_1_link, gst_return_year_2_link, gst_return_year_3_link, it_return_year_1_link, it_return_year_2_link, it_return_year_3_link, other_income_assessment_proof_link, cam_link, cfa_link].hash
    end
