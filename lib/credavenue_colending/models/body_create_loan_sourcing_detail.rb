...
module Colending
  ...
  class BodyCreateLoanSourcingDetail
    ...
    attr_accessor :relationship_manager
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Colending::BodyCreateLoanSourcingDetail` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Colending::BodyCreateLoanSourcingDetail`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'referrer_code')
        self.referrer_code = attributes[:'referrer_code']
      end

      if attributes.key?(:'referrer_group')
        self.referrer_group = attributes[:'referrer_group']
      end

      if attributes.key?(:'referrer_name')
        self.referrer_name = attributes[:'referrer_name']
      end
      ...
      if attributes.key?(:'dst_code')
        self.dst_code = attributes[:'dst_code']
      end

      if attributes.key?(:'dsa')
        self.dsa = attributes[:'dsa']
      end

      if attributes.key?(:'dse')
        self.dse = attributes[:'dse']
      end

      if attributes.key?(:'relationship_manager')
        self.relationship_manager = attributes[:'relationship_manager']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          referrer_code == o.referrer_code &&
          referrer_group == o.referrer_group &&
          referrer_name == o.referrer_name &&
          channel_code == o.channel_code &&
          dst_code == o.dst_code &&
          dsa == o.dsa &&
          dse == o.dse &&
          relationship_manager == o.relationship_manager
    end
    ...
    def hash
      [source_code, referrer_code, referrer_group, referrer_name, channel_code, dst_code, dsa, dse, relationship_manager].hash
    end
