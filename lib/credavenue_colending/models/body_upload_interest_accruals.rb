...
module Colending
  class BodyUploadInterestAccruals
    # Interest Accrual File URL
    attr_accessor :file_link

    # Interest Accrual File URL
    attr_accessor :file_link_password

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'file_link' => :'file_link',
        :'file_link_password' => :'file_link_password'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Colending::BodyUploadInterestAccruals` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Colending::BodyUploadInterestAccruals`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'file_link_password')
        self.file_link_password = attributes[:'file_link_password']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          file_link_password == o.file_link_password
    end
    ...
    def hash
      [file_link, file_link_password].hash
    end
