  ...
  class BodyCreateLoanInsuranceDetails
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Colending::BodyCreateLoanInsuranceDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Colending::BodyCreateLoanInsuranceDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'insurer_name')
        self.insurer_name = attributes[:'insurer_name']
      end

      if attributes.key?(:'nominee_details')
        self.nominee_details = attributes[:'nominee_details']
      end

      if attributes.key?(:'nominee_date_of_birth')
        self.nominee_date_of_birth = attributes[:'nominee_date_of_birth']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          nominee_details == o.nominee_details &&
          nominee_date_of_birth == o.nominee_date_of_birth &&
    ...
    def hash
      [insurance_type, insurer_name, nominee_details, nominee_date_of_birth, relationship, premium, insurance_amount, policy_number].hash
    end
