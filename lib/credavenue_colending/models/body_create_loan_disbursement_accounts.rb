...
module Colending
  ...
  class BodyCreateLoanDisbursementAccounts
    ...
    attr_accessor :date_of_bank_account_opening

    # Bank branch name where disbursement needs to be done
    attr_accessor :bank_branch_name
    ...
    def self.attribute_map
      {
        ...
        :'date_of_bank_account_opening' => :'date_of_bank_account_opening',
    ...
    def self.openapi_types
      {
        ...
        :'account_name' => :'Object',
        :'date_of_bank_account_opening' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Colending::BodyCreateLoanDisbursementAccounts` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Colending::BodyCreateLoanDisbursementAccounts`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'date_of_bank_account_opening')
        self.date_of_bank_account_opening = attributes[:'date_of_bank_account_opening']
      end

      if attributes.key?(:'bank_branch_name')
        self.bank_branch_name = attributes[:'bank_branch_name']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          date_of_bank_account_opening == o.date_of_bank_account_opening &&
          bank_branch_name == o.bank_branch_name &&
    ...
    def hash
      [account_type, bank_name, bank_account_type, account_name, date_of_bank_account_opening, bank_branch_name, ifsc_code, entity_type, account_no, amount].hash
    end
