...
module Colending
  ...
  class ResponseCreateTrancheBusinessDataPartnershipDetail
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Colending::ResponseCreateTrancheBusinessDataPartnershipDetail` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Colending::ResponseCreateTrancheBusinessDataPartnershipDetail`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'partnership_pan_link')
        self.partnership_pan_link = attributes[:'partnership_pan_link']
      end
      ...
      if attributes.key?(:'partnership_deed_link')
        self.partnership_deed_link = attributes[:'partnership_deed_link']
      end
      ...
      if attributes.key?(:'beneficiary_owner_details_link')
        self.beneficiary_owner_details_link = attributes[:'beneficiary_owner_details_link']
      end
