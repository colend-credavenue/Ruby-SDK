...
module Colending
  class BodyCreateAdvanceCollection
    # Advance Amount
    ...
    attr_accessor :advance_outstanding
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Colending::BodyCreateAdvanceCollection` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Colending::BodyCreateAdvanceCollection`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'advance_outstanding')
        self.advance_outstanding = attributes[:'advance_outstanding']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          advance_outstanding == o.advance_outstanding &&
    ...
    def hash
      [amount, transaction_date, investor_transfer_date, instrument_number, instrument_type, advance_outstanding, transaction_type, comment].hash
    end
