...
module Colending
  class BodyCreateCollectionEntry
    # Installment Number
    attr_accessor :installment_no
    ...
    attr_accessor :overdue_charges

    # Penalty Charges Paid
    attr_accessor :penalty_charges

    # Fee Charges Paid
    attr_accessor :fee_charges

    # Bounce charges paid
    attr_accessor :bounce_charges
    ...
    attr_accessor :investor_transfer_date
    ...
    attr_accessor :emi_closed

    # Y / N. Input Y if the loan is foreclosed.
    attr_accessor :foreclosure
    ...
    def self.attribute_map
      {
        ...
        :'amount' => :'amount',
        :'paid_date' => :'paid_date',
        :'investor_transfer_date' => :'investor_transfer_date',
        :'reference_no' => :'reference_no',
        :'instrument_type' => :'instrument_type',
        :'emi_closed' => :'emi_closed',
        :'foreclosure' => :'foreclosure',
        :'payment_type' => :'payment_type',
        :'pos' => :'pos',
        :'updated_rs' => :'updated_rs'
      }
    end
    ...
    def self.openapi_types
      {
        :'installment_no' => :'Object',
        :'due_date' => :'Object',
        :'principal' => :'Object',
        :'interest' => :'Object',
        :'other_charges' => :'Object',
        :'overdue_charges' => :'Object',
        :'penalty_charges' => :'Object',
        :'fee_charges' => :'Object',
        :'bounce_charges' => :'Object',
        :'amount' => :'Object',
        :'paid_date' => :'Object',
        :'investor_transfer_date' => :'Object',
        :'reference_no' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Colending::BodyCreateCollectionEntry` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Colending::BodyCreateCollectionEntry`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'installment_no')
        self.installment_no = attributes[:'installment_no']
      end
      ...
      if attributes.key?(:'overdue_charges')
        self.overdue_charges = attributes[:'overdue_charges']
      end

      if attributes.key?(:'penalty_charges')
        self.penalty_charges = attributes[:'penalty_charges']
      end

      if attributes.key?(:'fee_charges')
        self.fee_charges = attributes[:'fee_charges']
      end

      if attributes.key?(:'bounce_charges')
        self.bounce_charges = attributes[:'bounce_charges']
      end
      ...
      if attributes.key?(:'investor_transfer_date')
        self.investor_transfer_date = attributes[:'investor_transfer_date']
      end
      ...
      if attributes.key?(:'emi_closed')
        self.emi_closed = attributes[:'emi_closed']
      end

      if attributes.key?(:'foreclosure')
        self.foreclosure = attributes[:'foreclosure']
      end
      ...
      if attributes.key?(:'updated_rs')
        if (value = attributes[:'updated_rs']).is_a?(Array)
          self.updated_rs = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          overdue_charges == o.overdue_charges &&
          penalty_charges == o.penalty_charges &&
          fee_charges == o.fee_charges &&
          bounce_charges == o.bounce_charges &&
          amount == o.amount &&
          paid_date == o.paid_date &&
          investor_transfer_date == o.investor_transfer_date &&
          reference_no == o.reference_no &&
          instrument_type == o.instrument_type &&
          emi_closed == o.emi_closed &&
          foreclosure == o.foreclosure &&
          payment_type == o.payment_type &&
          pos == o.pos &&
          updated_rs == o.updated_rs
    end
    ...
    def hash
      [installment_no, due_date, principal, interest, other_charges, overdue_charges, penalty_charges, fee_charges, bounce_charges, amount, paid_date, investor_transfer_date, reference_no, instrument_type, emi_closed, foreclosure, payment_type, pos, updated_rs].hash
    end
