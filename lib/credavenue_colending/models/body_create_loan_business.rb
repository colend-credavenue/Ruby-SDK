...
module Colending
  ...
  class BodyCreateLoanBusiness
    # Business name
    attr_accessor :name_of_business

    # The sector this business belongs to
    attr_accessor :nature_of_business

    # Partnership/Propertorship/Private Ltd
    attr_accessor :type_of_constitution

    # Type of Ownership
    attr_accessor :type_of_ownership
    ...
    # Name of the sector
    attr_accessor :sector_type

    # Name of the Sub sector
    attr_accessor :sub_sector_type

    # Number of years of business existence
    attr_accessor :business_vintage

    # Address of the business location
    attr_accessor :business_registered_office_address

    # Address of the business location
    attr_accessor :business_registered_office_district

    # City of business address
    attr_accessor :business_registered_office_city

    # State of business address
    attr_accessor :business_registered_office_state

    # Pincode of business address
    attr_accessor :business_registered_office_pincode

    # Address of business location
    attr_accessor :business_mailing_office_address

    # City of business address
    attr_accessor :business_mailing_office_city

    # State of business location
    attr_accessor :business_mailing_office_state

    # Pincode of business location
    attr_accessor :business_mailing_office_pincode

    # Registered office document
    attr_accessor :business_registered_office_link

    # Registered office document password
    attr_accessor :business_registered_office_link_password

    # Mailing office document
    attr_accessor :business_mailing_office_link

    # Mailing office document password
    attr_accessor :business_mailing_office_link_password

    # Phone number of business address
    attr_accessor :business_phone_number

    # Email id of the business
    attr_accessor :business_email_id

    # Partner score for the business
    attr_accessor :business_partner_score
    ...
    def self.attribute_map
      {
        ...
        :'type_of_constitution' => :'type_of_constitution',
        :'type_of_ownership' => :'type_of_ownership',
        :'registration_date' => :'registration_date',
        :'incorporation_date' => :'incorporation_date',
        :'industry_type' => :'industry_type',
        :'sector_type' => :'sector_type',
        :'sub_sector_type' => :'sub_sector_type',
        :'business_vintage' => :'business_vintage',
        :'business_registered_office_address' => :'business_registered_office_address',
        :'business_registered_office_district' => :'business_registered_office_district',
        :'business_registered_office_city' => :'business_registered_office_city',
        :'business_registered_office_state' => :'business_registered_office_state',
        :'business_registered_office_pincode' => :'business_registered_office_pincode',
        :'business_mailing_office_address' => :'business_mailing_office_address',
        :'business_mailing_office_city' => :'business_mailing_office_city',
        :'business_mailing_office_state' => :'business_mailing_office_state',
        :'business_mailing_office_pincode' => :'business_mailing_office_pincode',
        :'business_registered_office_link' => :'business_registered_office_link',
        :'business_registered_office_link_password' => :'business_registered_office_link_password',
        :'business_mailing_office_link' => :'business_mailing_office_link',
        :'business_mailing_office_link_password' => :'business_mailing_office_link_password',
        :'business_phone_number' => :'business_phone_number',
        :'business_email_id' => :'business_email_id',
        :'business_partner_score' => :'business_partner_score',
    ...
    def self.openapi_types
      {
        ...
        :'type_of_constitution' => :'Object',
        :'type_of_ownership' => :'Object',
        :'registration_date' => :'Object',
        :'incorporation_date' => :'Object',
        :'industry_type' => :'Object',
        :'sector_type' => :'Object',
        :'sub_sector_type' => :'Object',
        :'business_vintage' => :'Object',
        :'business_registered_office_address' => :'Object',
        :'business_registered_office_district' => :'Object',
        :'business_registered_office_city' => :'Object',
        :'business_registered_office_state' => :'Object',
        :'business_registered_office_pincode' => :'Object',
        :'business_mailing_office_address' => :'Object',
        :'business_mailing_office_city' => :'Object',
        :'business_mailing_office_state' => :'Object',
        :'business_mailing_office_pincode' => :'Object',
        :'business_registered_office_link' => :'Object',
        :'business_registered_office_link_password' => :'Object',
        :'business_mailing_office_link' => :'Object',
        :'business_mailing_office_link_password' => :'Object',
        :'business_phone_number' => :'Object',
        :'business_email_id' => :'Object',
        :'business_partner_score' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Colending::BodyCreateLoanBusiness` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Colending::BodyCreateLoanBusiness`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'name_of_business')
        self.name_of_business = attributes[:'name_of_business']
      end
      ...
      if attributes.key?(:'type_of_constitution')
        self.type_of_constitution = attributes[:'type_of_constitution']
      end

      if attributes.key?(:'type_of_ownership')
        self.type_of_ownership = attributes[:'type_of_ownership']
      end
      ...
      if attributes.key?(:'sector_type')
        self.sector_type = attributes[:'sector_type']
      end

      if attributes.key?(:'sub_sector_type')
        self.sub_sector_type = attributes[:'sub_sector_type']
      end

      if attributes.key?(:'business_vintage')
        self.business_vintage = attributes[:'business_vintage']
      end

      if attributes.key?(:'business_registered_office_address')
        self.business_registered_office_address = attributes[:'business_registered_office_address']
      end

      if attributes.key?(:'business_registered_office_district')
        self.business_registered_office_district = attributes[:'business_registered_office_district']
      end

      if attributes.key?(:'business_registered_office_city')
        self.business_registered_office_city = attributes[:'business_registered_office_city']
      end

      if attributes.key?(:'business_registered_office_state')
        self.business_registered_office_state = attributes[:'business_registered_office_state']
      end

      if attributes.key?(:'business_registered_office_pincode')
        self.business_registered_office_pincode = attributes[:'business_registered_office_pincode']
      end

      if attributes.key?(:'business_mailing_office_address')
        self.business_mailing_office_address = attributes[:'business_mailing_office_address']
      end

      if attributes.key?(:'business_mailing_office_city')
        self.business_mailing_office_city = attributes[:'business_mailing_office_city']
      end

      if attributes.key?(:'business_mailing_office_state')
        self.business_mailing_office_state = attributes[:'business_mailing_office_state']
      end

      if attributes.key?(:'business_mailing_office_pincode')
        self.business_mailing_office_pincode = attributes[:'business_mailing_office_pincode']
      end

      if attributes.key?(:'business_registered_office_link')
        if (value = attributes[:'business_registered_office_link']).is_a?(Array)
          self.business_registered_office_link = value
        end
      end

      if attributes.key?(:'business_registered_office_link_password')
        self.business_registered_office_link_password = attributes[:'business_registered_office_link_password']
      end

      if attributes.key?(:'business_mailing_office_link')
        if (value = attributes[:'business_mailing_office_link']).is_a?(Array)
          self.business_mailing_office_link = value
        end
      end

      if attributes.key?(:'business_mailing_office_link_password')
        self.business_mailing_office_link_password = attributes[:'business_mailing_office_link_password']
      end

      if attributes.key?(:'business_phone_number')
        if (value = attributes[:'business_phone_number']).is_a?(Array)
          self.business_phone_number = value
        end
      end

      if attributes.key?(:'business_email_id')
        if (value = attributes[:'business_email_id']).is_a?(Array)
          self.business_email_id = value
        end
      end

      if attributes.key?(:'business_partner_score')
        self.business_partner_score = attributes[:'business_partner_score']
      end
      ...
      if attributes.key?(:'business_pan_link')
        if (value = attributes[:'business_pan_link']).is_a?(Array)
          self.business_pan_link = value
        end
      end
      ...
      if attributes.key?(:'business_rc_link')
        if (value = attributes[:'business_rc_link']).is_a?(Array)
          self.business_rc_link = value
        end
      end
      ...
      if attributes.key?(:'business_gst_copy_link')
        if (value = attributes[:'business_gst_copy_link']).is_a?(Array)
          self.business_gst_copy_link = value
        end
      end
      ...
      if attributes.key?(:'business_udyog_aadhar_link')
        if (value = attributes[:'business_udyog_aadhar_link']).is_a?(Array)
          self.business_udyog_aadhar_link = value
        end
      end
      ...
      if attributes.key?(:'business_ssi_link')
        if (value = attributes[:'business_ssi_link']).is_a?(Array)
          self.business_ssi_link = value
        end
      end
      ...
      if attributes.key?(:'business_shops_est_link')
        if (value = attributes[:'business_shops_est_link']).is_a?(Array)
          self.business_shops_est_link = value
        end
      end
      ...
      if attributes.key?(:'business_factory_regn_link')
        if (value = attributes[:'business_factory_regn_link']).is_a?(Array)
          self.business_factory_regn_link = value
        end
      end
      ...
      if attributes.key?(:'business_trade_license_link')
        if (value = attributes[:'business_trade_license_link']).is_a?(Array)
          self.business_trade_license_link = value
        end
      end
      ...
      if attributes.key?(:'business_place_photo_link')
        if (value = attributes[:'business_place_photo_link']).is_a?(Array)
          self.business_place_photo_link = value
        end
      end
      ...
      if attributes.key?(:'business_continuity_proof_link')
        if (value = attributes[:'business_continuity_proof_link']).is_a?(Array)
          self.business_continuity_proof_link = value
        end
      end
      ...
      if attributes.key?(:'partnerships')
        if (value = attributes[:'partnerships']).is_a?(Array)
          self.partnerships = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          name_of_business == o.name_of_business &&
          nature_of_business == o.nature_of_business &&
          type_of_constitution == o.type_of_constitution &&
          type_of_ownership == o.type_of_ownership &&
          registration_date == o.registration_date &&
          incorporation_date == o.incorporation_date &&
          industry_type == o.industry_type &&
          sector_type == o.sector_type &&
          sub_sector_type == o.sub_sector_type &&
          business_vintage == o.business_vintage &&
          business_registered_office_address == o.business_registered_office_address &&
          business_registered_office_district == o.business_registered_office_district &&
          business_registered_office_city == o.business_registered_office_city &&
          business_registered_office_state == o.business_registered_office_state &&
          business_registered_office_pincode == o.business_registered_office_pincode &&
          business_mailing_office_address == o.business_mailing_office_address &&
          business_mailing_office_city == o.business_mailing_office_city &&
          business_mailing_office_state == o.business_mailing_office_state &&
          business_mailing_office_pincode == o.business_mailing_office_pincode &&
          business_registered_office_link == o.business_registered_office_link &&
          business_registered_office_link_password == o.business_registered_office_link_password &&
          business_mailing_office_link == o.business_mailing_office_link &&
          business_mailing_office_link_password == o.business_mailing_office_link_password &&
          business_phone_number == o.business_phone_number &&
          business_email_id == o.business_email_id &&
          business_partner_score == o.business_partner_score &&
    ...
    def hash
      [name_of_business, nature_of_business, type_of_constitution, type_of_ownership, registration_date, incorporation_date, industry_type, sector_type, sub_sector_type, business_vintage, business_registered_office_address, business_registered_office_district, business_registered_office_city, business_registered_office_state, business_registered_office_pincode, business_mailing_office_address, business_mailing_office_city, business_mailing_office_state, business_mailing_office_pincode, business_registered_office_link, business_registered_office_link_password, business_mailing_office_link, business_mailing_office_link_password, business_phone_number, business_email_id, business_partner_score, business_pan_number, business_pan_link, business_pan_link_password, business_rc_number, business_rc_link, business_rc_link_password, business_gst_number, business_gst_copy_link, business_gst_copy_link_password, business_udyog_aadhar_number, business_udyog_aadhar_link, business_udyog_aadhar_link_password, business_ssi_number, business_ssi_link, business_ssi_link_password, business_shops_est_number, business_shops_est_link, business_shops_est_link_password, business_factory_regn_number, business_factory_regn_link, business_factory_regn_link_password, business_trade_license_number, business_trade_license_link, business_trade_license_link_password, business_place_photo_link, business_place_photo_link_password, business_continuity_proof_link, business_continuity_proof_link_password, other_business_address_proof_number, other_business_address_proof_link, other_business_address_proof_link_password, no_of_business_authorised_persons, partnerships, partnership_detail, private_entity_detail].hash
    end
