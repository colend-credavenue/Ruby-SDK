...
body = Colending::BodyCreateLoan.new(
        ...
        bank_statement=BodyCreateLoanBankStatement(
            ...
            number_of_bank_transactions="number_of_bank_transactions_example",
            number_of_inward_transactions="number_of_inward_transactions_example"
        ),
        ...
        loan_eligibility_to_income_ratio=3
        risk_category=red
        salary_credit_declared_income=2
